...
import { typeScale, primaryFont, headingFont } from "../utils";
...
export const Button = styled.button`
  ...
  transition: background-color 0.2s linear, color 0.2s linear, box-shadow 0.3s linear;
  &:hover {
    background-color: ${props => props.theme.primaryHoverColor};
    color: ${props => props.theme.textColorOnPrimary};
    box-shadow: 0px 0px 1px ${props => props.theme.textColorInverted}
  }
  &:focus {
